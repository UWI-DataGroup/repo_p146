...
** ***************************************************
import excel "`datapath'\FoodOutletswithEDs_TableToExcel.xlsx", sheet("FoodOutletswithEDs_TableToExcel") firstrow
...
label variable Unhealthy1 "Unhealthy"

gen Healthy1=0
replace Healthy1=1 if OUTLET_Cat == 2 | OUTLET_Cat == 6 | OUTLET_Cat == 7
label variable Healthy1 "Healthy"
...
import excel "C:\Users\steph\The University of the West Indies\DataGroup - repo_data\data_p146\version01\ArcGIS\Paper1_ Deserts_Swamps\EDsToUnhealthy.xlsx", sheet("EDsToUnhealthy") 
firstrow clear
...
save "C:\Users\steph\The University of the West Indies\DataGroup - repo_data\data_p146\version01\ArcGIS\Paper1_ Deserts_Swamps\DistanceUnhealthy.dta"
...
// imported from ArcGIS
******************************************************************************
import excel "C:\Users\steph\The University of the West Indies\DataGroup - repo_data\data_p146\version01\ArcGIS\Paper1_ Deserts_Swamps\EDsToHealthy.xlsx", sheet("EDsToHealthy") firstrow clear
drop ENUM_NO1_1 ENUM_NO1_1 Buff1 Buff2 Buff3 k InsideBuff OutsideBuf InsideBu_1 OutsideB_1 InsideBu_2 OutsideB_2 FoodDesert FoodDese_1 FoodDese_2 ENUM_NO1_2 Buff1_1 Buff2_1 Buff3_1 k_1 InsideBu_3 OutsideB_3 InsideBu_4 OutsideB_4 InsideBu_5 OutsideB_5 FoodDese_3 FoodDese_4 FoodDese_5
encode PARISHNAM1, gen (PARISH)
label variable NEAR_DIST "Distance_Healthy"
rename NEAR_DIST Distance_Healthy
save "C:\Users\steph\The University of the West Indies\DataGroup - repo_data\data_p146\version01\ArcGIS\Paper1_ Deserts_Swamps\DistanceHealthy.dta"


************************************************************************************
** PART 5. Merging datasets with distances to Healthy and Unhealthy food outlets per ED
****************************************************************************************
merge 1:1 ENUM_NO1 using "C:\Users\steph\The University of the West Indies\DataGroup - repo_data\data_p146\version01\ArcGIS\Paper1_ Deserts_Swamps\DistanceUnhealthy.dta"
drop OBJECTID_1 _merge
save "C:\Users\steph\The University of the West Indies\DataGroup - repo_data\data_p146\version01\ArcGIS\Paper1_ Deserts_Swamps\DistancetoFoodOutlets.dta"
